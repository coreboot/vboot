...
enum vb2_return_code {
	 ...
	 */
	VB2_ERROR_AVB = VB2_ERROR_HOST_BASE + 0x070000,

	/* AVB_SLOT_VERIFY_RESULT_ERROR_OOM */
	VB2_ERROR_AVB_OOM,

	/* AVB_SLOT_VERIFY_RESULT_ERROR_IO */
	VB2_ERROR_AVB_ERROR_IO,

	/* AVB_SLOT_VERIFY_RESULT_ERROR_VERIFICATION */
	VB2_ERROR_AVB_ERROR_VERIFICATION,

	/* AVB_SLOT_VERIFY_RESULT_ERROR_ROLLBACK_INDEX */
	VB2_ERROR_AVB_ERROR_ROLLBACK_INDEX,

	/* AVB_SLOT_VERIFY_RESULT_ERROR_PUBLIC_KEY_REJECTED */
	VB2_ERROR_AVB_ERROR_PUBLIC_KEY_REJECTED,

	/* AVB_SLOT_VERIFY_RESULT_ERROR_INVALID_METADATA */
	VB2_ERROR_AVB_ERROR_INVALID_METADATA,

	/* AVB_SLOT_VERIFY_RESULT_ERROR_UNSUPPORTED_VERSION */
	VB2_ERROR_AVB_ERROR_UNSUPPORTED_VERSION,

	/* AVB_SLOT_VERIFY_RESULT_ERROR_INVALID_ARGUMENT */
	VB2_ERROR_AVB_ERROR_INVALID_ARGUMENT,
